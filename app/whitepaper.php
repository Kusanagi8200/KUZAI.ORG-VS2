        ...
        [
            ...
            'features' => [
                ...
                [
                    ...
                    'text' => "Profile creation, editing, JSON preview, server-side storage, activation, runtime selection, listing, deletion, and session-level application for specialized assistant behavior.",
                ],
                [
